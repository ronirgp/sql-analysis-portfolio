-- Find employees whose salary is at least $1,000 below the highest salary in their -- 
-- department.
...
-- Only return employees meeting the $1,000 requirement.
...
FROM salary 
WHERE employee_salary - highest_department_salary <= -1000
