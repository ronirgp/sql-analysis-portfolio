-- Find employees whose salary is at least $800 above the lowest salary in their department.
-- Return:
-- employee name
-- department ID
-- employee salary
...
-- Only return employees meeting the $800 requirement.
...
FROM salary
WHERE employee_salary - lowest_department_salary >= 800
